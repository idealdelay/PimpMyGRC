...
* selection {
    background-color: #ff2ea6;   /* make it VERY obvious */
    color: #000000;
}
...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #142814; color: #DDDDDD;
    border-bottom: 1px solid #00FFFF;
}
menubar, menubar > menuitem {
    background-color: #142814; color: #DDDDDD;
}
menubar > menuitem:hover { background-color: #00FFFF; }
menu, .context-menu {
    background-color: #142814; color: #DDDDDD;
    border: 1px solid #00FFFF;
}
menu menuitem:hover { background-color: #00FFFF; }
toolbar, .toolbar {
    background-color: #142814; color: #DDDDDD;
    border-bottom: 1px solid #00FFFF;
}
toolbar button { color: #DDDDDD; background: transparent; }
toolbar button:hover { background-color: #00FFFF; }
"""
        _tp = Gtk.CssProvider()
