...
class Connection(CoreConnection, Drawable):
    ...
    # ---- Hacker vibe palette (RGBA) ----
    _NEON_WIRE = (0.00, 1.00, 0.60, 1.0)      # neon green
    _NEON_ARROW = (0.00, 0.85, 1.00, 1.0)     # cyan
    _NEON_HIGHLIGHT = (1.00, 0.20, 0.90, 1.0) # hot pink
    _NEON_DISABLED = (0.30, 0.30, 0.30, 1.0)  # gray
    _NEON_ERROR = (1.00, 0.15, 0.15, 1.0)     # red
    # -----------------------------------
