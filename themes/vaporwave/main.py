...
* selection {
    background-color: #FF1493;   /* deep pink selection */
    color: #000000;
}
...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #1A1A2E; color: #E0D0FF;
    border-bottom: 1px solid #CC88FF;
}
menubar, menubar > menuitem {
    background-color: #1A1A2E; color: #E0D0FF;
}
menubar > menuitem:hover { background-color: #CC88FF; }
menu, .context-menu {
    background-color: #1A1A2E; color: #E0D0FF;
    border: 1px solid #CC88FF;
}
menu menuitem:hover { background-color: #CC88FF; }
toolbar, .toolbar {
    background-color: #1A1A2E; color: #E0D0FF;
    border-bottom: 1px solid #CC88FF;
}
toolbar button { color: #E0D0FF; background: transparent; }
toolbar button:hover { background-color: #CC88FF; }
"""
        _tp = Gtk.CssProvider()
