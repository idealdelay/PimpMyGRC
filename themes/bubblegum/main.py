...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #2A1A2E; color: #FFE0EE;
    border-bottom: 1px solid #FF88CC;
}
menubar, menubar > menuitem {
    background-color: #2A1A2E; color: #FFE0EE;
}
menubar > menuitem:hover { background-color: #FF88CC; }
menu, .context-menu {
    background-color: #2A1A2E; color: #FFE0EE;
    border: 1px solid #FF88CC;
}
menu menuitem:hover { background-color: #FF88CC; }
toolbar, .toolbar {
    background-color: #2A1A2E; color: #FFE0EE;
    border-bottom: 1px solid #FF88CC;
}
toolbar button { color: #FFE0EE; background: transparent; }
toolbar button:hover { background-color: #FF88CC; }
"""
        _tp = Gtk.CssProvider()
