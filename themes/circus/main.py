...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #1A1A0A; color: #FFEEAA;
    border-bottom: 1px solid #FFDD00;
}
menubar, menubar > menuitem {
    background-color: #1A1A0A; color: #FFEEAA;
}
menubar > menuitem:hover { background-color: #FFDD00; }
menu, .context-menu {
    background-color: #1A1A0A; color: #FFEEAA;
    border: 1px solid #FFDD00;
}
menu menuitem:hover { background-color: #FFDD00; }
toolbar, .toolbar {
    background-color: #1A1A0A; color: #FFEEAA;
    border-bottom: 1px solid #FFDD00;
}
toolbar button { color: #FFEEAA; background: transparent; }
toolbar button:hover { background-color: #FFDD00; }
"""
        _tp = Gtk.CssProvider()
