...
class Connection(CoreConnection, Drawable):
    ...
    # ---- Phosphor Terminal palette (RGBA) ----
    _NEON_WIRE = (0.20, 1.00, 0.20, 1.0)       # bright phosphor green
    _NEON_ARROW = (0.20, 1.00, 0.20, 1.0)      # same green
    _NEON_HIGHLIGHT = (1.00, 0.70, 0.00, 1.0)  # amber highlight
    _NEON_DISABLED = (0.12, 0.20, 0.12, 1.0)   # dim green-grey
    _NEON_ERROR = (1.00, 0.20, 0.00, 1.0)      # red-orange
    # ------------------------------------------
