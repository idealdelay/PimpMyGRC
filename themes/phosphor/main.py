...
* selection {
    background-color: #33FF33;   /* phosphor green selection */
    color: #000000;
}
...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #0A1E0A; color: #CCDDCC;
    border-bottom: 1px solid #33FF33;
}
menubar, menubar > menuitem {
    background-color: #0A1E0A; color: #CCDDCC;
}
menubar > menuitem:hover { background-color: #33FF33; }
menu, .context-menu {
    background-color: #0A1E0A; color: #CCDDCC;
    border: 1px solid #33FF33;
}
menu menuitem:hover { background-color: #33FF33; }
toolbar, .toolbar {
    background-color: #0A1E0A; color: #CCDDCC;
    border-bottom: 1px solid #33FF33;
}
toolbar button { color: #CCDDCC; background: transparent; }
toolbar button:hover { background-color: #33FF33; }
"""
        _tp = Gtk.CssProvider()
