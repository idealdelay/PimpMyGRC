...
* selection {
    background-color: #B58900;   /* solarized yellow selection */
    color: #000000;
}
...
menubar > menuitem:hover { background-color: #268BD2; }
menu, .context-menu {
    background-color: #002B36; color: #839496;
    border: 1px solid #268BD2;
}
menu menuitem:hover { background-color: #268BD2; }
toolbar, .toolbar {
    background-color: #002B36; color: #839496;
    border-bottom: 1px solid #268BD2;
}
toolbar button { color: #839496; background: transparent; }
toolbar button:hover { background-color: #268BD2; }
"""
        _tp = Gtk.CssProvider()
