...
* selection {
    background-color: #88CCFF;   /* ice blue selection */
    color: #000000;
}
...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #0A1628; color: #E0E8F0;
    border-bottom: 1px solid #66CCFF;
}
menubar, menubar > menuitem {
    background-color: #0A1628; color: #E0E8F0;
}
menubar > menuitem:hover { background-color: #66CCFF; }
menu, .context-menu {
    background-color: #0A1628; color: #E0E8F0;
    border: 1px solid #66CCFF;
}
menu menuitem:hover { background-color: #66CCFF; }
toolbar, .toolbar {
    background-color: #0A1628; color: #E0E8F0;
    border-bottom: 1px solid #66CCFF;
}
toolbar button { color: #E0E8F0; background: transparent; }
toolbar button:hover { background-color: #66CCFF; }
"""
        _tp = Gtk.CssProvider()
