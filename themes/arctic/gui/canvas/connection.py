...
class Connection(CoreConnection, Drawable):
    ...
    # ---- Arctic/Ice palette (RGBA) ----
    _NEON_WIRE = (0.40, 0.73, 0.93, 1.0)       # pale blue
    _NEON_ARROW = (0.53, 0.80, 1.00, 1.0)      # light blue
    _NEON_HIGHLIGHT = (1.00, 1.00, 1.00, 1.0)  # white
    _NEON_DISABLED = (0.10, 0.16, 0.22, 1.0)   # dim navy
    _NEON_ERROR = (1.00, 0.27, 0.27, 1.0)      # red
    # ------------------------------------------
