...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #1A0A2E; color: #FFCCFF;
    border-bottom: 1px solid #FF00FF;
}
menubar, menubar > menuitem {
    background-color: #1A0A2E; color: #FFCCFF;
}
menubar > menuitem:hover { background-color: #FF00FF; }
menu, .context-menu {
    background-color: #1A0A2E; color: #FFCCFF;
    border: 1px solid #FF00FF;
}
menu menuitem:hover { background-color: #FF00FF; }
toolbar, .toolbar {
    background-color: #1A0A2E; color: #FFCCFF;
    border-bottom: 1px solid #FF00FF;
}
toolbar button { color: #FFCCFF; background: transparent; }
toolbar button:hover { background-color: #FF00FF; }
"""
        _tp = Gtk.CssProvider()
