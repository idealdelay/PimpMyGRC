...
class Connection(CoreConnection, Drawable):
    ...
    # ---- Cyberpunk Red palette (RGBA) ----
    _NEON_WIRE = (1.00, 0.70, 0.00, 1.0)       # gold
    _NEON_ARROW = (1.00, 0.70, 0.00, 1.0)      # gold
    _NEON_HIGHLIGHT = (1.00, 0.84, 0.00, 1.0)  # bright gold
    _NEON_DISABLED = (0.16, 0.08, 0.08, 1.0)   # dim red
    _NEON_ERROR = (1.00, 0.00, 0.00, 1.0)      # pure red
    # ------------------------------------------
