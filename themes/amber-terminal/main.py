...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #1A1000; color: #FFE0AA;
    border-bottom: 1px solid #FFB300;
}
menubar, menubar > menuitem {
    background-color: #1A1000; color: #FFE0AA;
}
menubar > menuitem:hover { background-color: #FFB300; }
menu, .context-menu {
    background-color: #1A1000; color: #FFE0AA;
    border: 1px solid #FFB300;
}
menu menuitem:hover { background-color: #FFB300; }
toolbar, .toolbar {
    background-color: #1A1000; color: #FFE0AA;
    border-bottom: 1px solid #FFB300;
}
toolbar button { color: #FFE0AA; background: transparent; }
toolbar button:hover { background-color: #FFB300; }
"""
        _tp = Gtk.CssProvider()
