...
* selection {
    background-color: #FFB300;   /* amber selection */
    color: #000000;
}
...
try:
    ...
    if _toolbar_on:
        _toolbar_css = b"""
headerbar, .titlebar {
    background-color: #1A1C14; color: #C0C8A0;
    border-bottom: 1px solid #8B9A46;
}
menubar, menubar > menuitem {
    background-color: #1A1C14; color: #C0C8A0;
}
menubar > menuitem:hover { background-color: #8B9A46; }
menu, .context-menu {
    background-color: #1A1C14; color: #C0C8A0;
    border: 1px solid #8B9A46;
}
menu menuitem:hover { background-color: #8B9A46; }
toolbar, .toolbar {
    background-color: #1A1C14; color: #C0C8A0;
    border-bottom: 1px solid #8B9A46;
}
toolbar button { color: #C0C8A0; background: transparent; }
toolbar button:hover { background-color: #8B9A46; }
"""
        _tp = Gtk.CssProvider()
